...
public class EditBookAction extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private String filePath = "D:\\workSpace\\SchoolOldBook\\WebContent\\resource\\upload";    // 文件存放目录    
	private String tempPath = "D:\\workSpace\\SchoolOldBook\\WebContent\\resource\\backup";    // 临时文件目录  
...
//        res.setContentType("text/plain;charset=UTF-8");    
        ...
        try{    
            ...
            String moto = (String)bookMap.get("hiddenBookName");
            ...
            BookBean bb = new BookBean(0, bookName, grade, bookObject,
					price, desc, physical, "","", url);
            BooksDaoIface bd = new BooksDaoImpl();
            int editBook = bd.modifyProById(con, bb, moto);
            if(editBook>0){
