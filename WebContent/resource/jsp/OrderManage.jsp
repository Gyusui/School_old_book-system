...
<script type="text/javascript">
	...
	function deleteGrade(){
		...
		for(var i=0;i<selectedRows.length;i++){
			strIds.push("\""+selectedRows[i].orderid+"\"");
		}
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("/SchoolOldBook/deleteOrder.mis",{orderid:ids},function(result){
					if(result.success){
...
<body style="margin: 5px;">
	<table id="dg" title="订单详情" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="/SchoolOldBook/orderList.mis" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="orderid" width="150" align="center">订单号</th>
				<th field="userid" width="100" align="center">用户名称</th>
				<th field="price" width="50" align="center">订单总价</th>
				<th field="phone" width="50" align="center">联系方式</th>
				<th field="receiptaddress" width="250" align="center">收货地址</th>
			</tr>
		</thead>
	</table>
