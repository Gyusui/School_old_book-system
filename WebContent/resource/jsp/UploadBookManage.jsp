...
<script type="text/javascript">
	...
	function deleteGrade(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确认要审批这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("/SchoolOldBook/checkBook.mis",{bookname:ids},function(result){
					if(result.success){
						$.messager.alert("系统提示","您已成功审批<font color=red>"+result.delNums+"</font>条数据！现已将其加入商品库");
						$("#dg").datagrid("reload");
					}else{
...
<body style="margin: 5px;">
	<table id="dg" title="班级信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="/SchoolOldBook/uploadBookList.mis" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="description" width="250" align="center">图书描述</th>
				<th field="userId" width="100" align="center">上传用户</th>
				<th field="status" width="50" align="center" formatter="statusFormatter">审批状态</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:deleteGrade()" class="easyui-linkbutton" iconCls="icon-add" plain="true">审批</a>
		</div>
